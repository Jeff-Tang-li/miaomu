...
public class ResultResponse {
    ...
    public static ResultResponse successful(String message) {
        return successful(ResponseEnum.RESPONSE_ENUM_SUCCESS.getCode(), message, null);
    }
    ...
    public static ResultResponse error(Object t) {
        return error(ResponseEnum.RESPONSE_ENUM_USER_ERROR.getCode(), "FAILURE", t);
    }
